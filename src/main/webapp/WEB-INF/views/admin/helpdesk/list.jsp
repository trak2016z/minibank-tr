        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${helpdesks}" var="help">
                <tr>
                    ...
                    <td>${help.title}</td>
                    <td>${help.question}</td>
                    <td>${help.user.ssoId}</td>
                        <td><a href="<c:url value='/admin/helpdesk/answer-${help.id}' />" class="btn btn-success custom-width">ODPOWIEDZ</a></td>
                        <td><a href="#" data-href="<c:url value='/admin/helpdesk/delete-${help.id}' />" data-toggle="modal" data-target="#deleteModal" class="btn btn-danger custom-width">USUŃ</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Czy na pewno chcesz dokonać usunięcia to zgłoszenie?</p>
            </div>
