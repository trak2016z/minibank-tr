...
<head>
	...
	<title>MiniBank - brak dostępu</title>
...
<header id="header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Brak uprawnień</li>
	</ol>
</header>
<div class="container-fluid">
	<div class="generic-container">
		<div class="authbar">
			<span>Drogi <strong>${loggedinuser}</strong>, Nie masz uprawnień do przeglądania tej strony.</span> <span class="floatRight"><a href="<c:url value="/logout" />">Wyloguj</a></span>
		</div>
	</div>
</div>
