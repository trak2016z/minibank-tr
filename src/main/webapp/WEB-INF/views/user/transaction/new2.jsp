        ...
        <tr class="panel-body">
            <div style="margin: auto; width: 300px;">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Podsumowanie</a></li>
                </ul>
            </div>
            <!-- Tab panes -->
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="home">
                    <c:url var="loginUrl" value="/dashboard/transaction/new/check" />
                    <form:form action="${loginUrl}" method="POST" modelAttribute="transaction" mehod="post" class="form-horizontal">
                        <table class="table table-striped">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <form:select path="source_wallet" id="source_wallet" class="form-control" >
                                            ...
                                            <c:choose>
                                            <c:when test="${source_wallet==source.id}">
                                                <option value="${source.id}"selected>${source.name}</option>
                                            </c:when>
                                            <c:otherwise>
                                                <option value="${source.id}" disabled>${source.name}</option>
                                            </c:otherwise>
                                            </c:choose>
                            ...
                            <tr><td>
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <form:input type="text" path="wallet_number" id="wallet_number" cssClass="form-control" required="required" readonly="true" />
                                        <div class="text-danger">
                            ...
                            <tr><td>
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <form:input type="text" path="name" id="name" cssClass="form-control" required="required" readonly="true" />
                                        <div class="text-danger">
                            ...
                            <tr><td>
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <form:input type="text" path="address1" id="address1" cssClass="form-control" readonly="true" />
                                        <div class="text-danger">
                            ...
                            <tr><td>
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <form:input type="text" path="address2" id="address2" cssClass="form-control" readonly="true" />
                                        <div class="text-danger">
                            ...
                            <tr><td>
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <form:input type="text" path="title" id="title" cssClass="form-control" required="required" readonly="true" />
                                        <div class="text-danger">
                            ...
                            <tr><td>
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <form:input type="text" path="value" id="value" cssClass="form-control" required="required" readonly="true" />
                                        <div class="text-danger">
                            ...
                            <tr><td>
                                <div class="form-group col-md-12">
                                    <label class="col-md-3 control-lable" for="token">Podaj kod nr ${token.getNumber()}:</label>
                                    <div class="col-md-7 checkbox">
                                        <form:input path="token" name="token" id="token" cssClass="form-control" />
